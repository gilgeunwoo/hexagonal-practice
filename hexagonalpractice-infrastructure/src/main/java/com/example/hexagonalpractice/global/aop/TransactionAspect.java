package com.example.hexagonalpractice.global.aop;
...
public class TransactionAspect {
    ...
    public Advisor transactionAdviceAdvisor() {
        ...
        pointcut.setExpression("@within(com.example.hexagonalpractice.annotation.UseCase)");
    ...
    public Advisor readOnlyTransactionAdviceAdvisor() {
        AspectJExpressionPointcut pointcut = new AspectJExpressionPointcut();
        pointcut.setExpression("@within(com.example.hexagonalpractice.annotation.ReadOnlyUseCase)");
